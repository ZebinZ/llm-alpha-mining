...
[English](project_scope.md) | **简体中文** · [返回首页](../README.zh-CN.md)

本仓库是 LLM 辅助自动化因子研究框架的精简展示版本，将长期保留的框架与一次研究的运行产物分开。框架包含候选提议和审查、数据与因子契约、计算、时间验证、组合成本评估及可恢复调度；供应商接口配置、实际因子目录和平台记录留在私有研究归档。
