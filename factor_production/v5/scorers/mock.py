...
from factor_production.v5.scorers.base import CandidateScorer, ScoreBatch, ScoreObservation
...
class MockScorer(CandidateScorer):
    ...
    def __init__(
        ...
        | Callable[[CandidateSpecV5], Mapping[str, float]],
        *,
        name: str = "mock_local",
    ) -> None:
        self.values = values
        ...
        for candidate in candidates:
            if callable(self.values):
                ...
                try:
                    ...
                    raise KeyError(f"mock score missing for {candidate.candidate_id}") from exc
            observations.append(
                ScoreObservation(
