...
from factor_production.v5.llm.transport.base import StructuredTransport
...
class FakeTransport(StructuredTransport):
    ...
    def __init__(
        ...
        *,
        ...
        self._scripts = {
            LLMRole(role): deque(items) for role, items in scripts.items()
        }
        self.usage = usage or Usage(input_tokens=20, output_tokens=10, cost_microusd=100)
