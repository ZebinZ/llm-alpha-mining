...
from factor_production.v5.llm.domain import StructuredCallRequest, StructuredCallResponse
...
class NetworkDeniedTransport(StructuredTransport):
    ...
    def complete(
        ...
        *,
        ...
        self.call_count += 1
        raise NetworkDenied("network access is disabled for the offline LLM control plane")
