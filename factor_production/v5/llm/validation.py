...
from factor_production.v5.llm.schemas import StructuredOutputError, parse_role_output
...
def validate_response_against_request(
    ...
    *,
    ...
    if allowed_model_ids is not None and response.model_id not in frozenset(allowed_model_ids):
