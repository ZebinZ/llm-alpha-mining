...
from factor_production.v5.artifacts.manifest import ArtifactRecord
from factor_production.v5.candidate_protocol_authority import (
    CandidateProtocolAuthority,
    CandidateProtocolAuthorityError,
)
from factor_production.v5.domain.enums import CandidateState, RunState
from factor_production.v5.domain.models import CandidateSpecV5
from factor_production.v5.orchestration.state import (
...
class SQLiteRepository:
    ...
    def _candidate_from_row(self, row: sqlite3.Row) -> CandidateRecord:
        spec = CandidateSpecV5.from_dict(json.loads(row["spec_json"]))
