...
from llm_alpha_mining.research.factors.complexity import (
    FactorComplexity,
    analyze_expression,
    enforce_complexity,
)
...
from llm_alpha_mining.research.factors.view import FactorDataView
...
class FactorEngineExecutionPolicy:
    ...
    preprocessing_order: str = "expression_then_aggregation_then_declared_preprocessing"
        ...
        *,
        ...
        if execution_policy is not None:
            if type(execution_policy) is not FactorEngineExecutionPolicy:
                raise TypeError("factor engine requires an exact execution policy")
