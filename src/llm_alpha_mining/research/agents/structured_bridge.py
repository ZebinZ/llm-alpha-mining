...
from llm_alpha_mining.research.agents.contracts import (
    AgentContext,
    AgentRole,
    AgentTask,
)
from llm_alpha_mining.research.core.hashing import hash_json, require_sha256
from llm_alpha_mining.research.experiments.spec import ExperimentSpec
from llm_alpha_mining.mining.llm.agents import ProposerAgent, StructuredCallExecutor
from llm_alpha_mining.mining.llm.safe_context import SafeResearchContext
from llm_alpha_mining.mining.llm.schemas import CandidateDraft, parse_role_output
...
class StructuredProposalBridge:
    """Bind structured proposal calls to explicit research task contracts."""
...
__all__ = ["LLMCallEvidence", "ProposalCallResult", "StructuredProposalBridge"]
