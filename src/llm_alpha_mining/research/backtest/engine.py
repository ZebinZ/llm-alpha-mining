...
from llm_alpha_mining.research.backtest.data import BacktestDataView
from llm_alpha_mining.research.backtest.metrics import MetricValue, performance_metrics
from llm_alpha_mining.research.backtest.spec import BacktestSpec
from llm_alpha_mining.research.core.hashing import hash_frame, hash_json
from llm_alpha_mining.research.costs import CostEstimator, CostModel, TradeSide
from llm_alpha_mining.research.portfolio import PortfolioResult
...
def _require_lineage_available(
    ...
    *,
    ...
    if pd.isna(available_at):
        raise ValueError(
            f"missing backtest availability:{field}:{observation_timestamp}:{security}"
        )
