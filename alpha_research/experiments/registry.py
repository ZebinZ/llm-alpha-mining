...
from alpha_research.experiments.approval import ApprovalGrant, ApprovalRevocation
from alpha_research.experiments.receipt import ExperimentReceipt
from alpha_research.experiments.spec import (
    DataPartition,
    ExperimentProfile,
    ExperimentSpec,
)
...
class ExperimentRegistry:
    ...
    def load_bound_components(
        ...
        if len(by_role) != len(rows) or set(by_role) != {
            ...
            raise ExperimentRegistryConflict(
                "stored experiment component roles differ"
            )
        ...
        for role, expected_hash in expected_bindings:
            ...
            if (
                ...
                or canonical != row["descriptor_json"]
            ):
                raise ExperimentRegistryConflict(
                    "stored component descriptor integrity differs"
                )
