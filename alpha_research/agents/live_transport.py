...
from factor_production.v5.llm.schemas import ROLE_SCHEMAS, schema_hash
...
# ``factor_production`` is an intentionally separate runtime package and is
# skipped by this package's mypy import policy.  Keep the exception confined to
# this single inheritance boundary; all request/response methods below remain
# fully typed.
class LiveStructuredTransport(StructuredTransport):  # type: ignore[misc]
